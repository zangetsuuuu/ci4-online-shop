                ...
                <div class="relative col-span-1 md:col-span-2 p-3 md:p-4">
                    ...
                    <div class="mt-5">
                        <div class="flex items-center justify-between">
                            ...
                            <button data-modal-target="edit-product-modal#1" data-modal-toggle="edit-product-modal#1" type="button" class="btn-admin flex items-center space-x-2">
                                ...
                                <div>Edit Info <span class="hidden md:inline">Produk</span></div>
                            </button>
                        </div>
                    </div>
                </div>
