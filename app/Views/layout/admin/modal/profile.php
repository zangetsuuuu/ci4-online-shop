    ...
    <div class="relative p-4 w-full max-w-3xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 class="text-lg md:text-xl font-semibold text-myBlack tracking-wide">Edit Profil</h3>
            ...
            <form action="">
                ...
                <div class="flex items-center justify-end space-x-3 p-4 md:p-5 border-t border-gray-200 rounded-b">
                    ...
                    <button type="submit" name="save_profile" class="btn-admin">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
