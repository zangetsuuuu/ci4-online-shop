    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <div class="p-5 md:p-6 text-center">
                ...
                <h3 class="mb-5 text-base font-normal text-gray-500 tracking-wide">Hapus item "<?= $item['product_name']; ?>" dari keranjang?</h3>
                <div class="flex items-center justify-center space-x-3">
                    ...
                    <button data-modal-hide="delete-cart-item-modal#<?= $item['id']; ?>" type="button" class="btn-alternative w-20">Tidak</button>
                </div>
            </div>
        </div>
    </div>
