    ...
    <div class="p-4 sm:ml-64">
        <div class="h-full p-4 mt-16 bg-white rounded-lg shadow-sm md:mt-14">
            <div class="flex items-center justify-between">
                ...
                <button data-modal-target="order-filter-modal" data-modal-toggle="order-filter-modal" class="duration-300 ease-in-out text-myBlack hover:text-gray-500">
                        ...
                        <?php if (!empty($orders)) : ?>
                            ...
                            foreach ($orders as $order) : ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap"><?= date('d M Y, H:i', strtotime($order['created_at'])); ?> WIB</td>
