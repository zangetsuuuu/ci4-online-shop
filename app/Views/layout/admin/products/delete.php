...
<?php for ($i = 1; $i <= 5; $i++) : ?>
<div id="delete-product-modal#<?= $i; ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <div class="p-5 md:p-6 text-center">
                ...
                <h3 class="mb-5 text-base font-normal text-gray-500 tracking-wide">Hapus produk "Indomie"?</h3>
                <div class="flex items-center justify-center space-x-3">
                    <button type="submit"class="btn-danger w-20">Ya</button>
                    <button data-modal-hide="delete-product-modal#<?= $i; ?>" type="button" class="btn-alternative w-20">Tidak</button>
                </div>
            </div>
        </div>
    </div>
