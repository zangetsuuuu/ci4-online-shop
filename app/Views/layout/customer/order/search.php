    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5">
                <h3 class="text-lg font-semibold tracking-wide md:text-xl text-myBlack">Cari Pesanan</h3>
            ...
            <!-- Modal body -->
            <form action="<?= base_url('order/search'); ?>" method="get">
                <?= csrf_field(); ?>
                <div class="p-4 md:p-5">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="search" name="keyword" class="ps-10 p-2.5 block w-full rounded-md bg-gray-50 border border-gray-300 placeholder-gray-400 text-myBlack focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 focus:shadow-md text-sm md:text-base" autofocus placeholder="Masukkan keyword..." required />
                    </div>
                </div>
                <!-- Modal footer -->
