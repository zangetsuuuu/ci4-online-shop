    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="h-full bg-white rounded-lg shadow-sm p-4 mt-3 md:mt-4">
            <?php if (isset($flashMessages)) :
                foreach ($flashMessages as $key => $flashMessage) :
                    if ($flashMessage['message']) : ?>
                        <div id="<?= $flashMessage['id'] ?>" class="flex items-center p-3 md:p-4 mb-4  tracking-wide rounded-lg bg-green-50 text-green-800" role="alert">
            ...
            <?php if (session()->getFlashdata('Stock Not Available')) : ?>
                <div id="alert-stock-not-available" class="flex items-center p-3 md:p-4 mb-4  tracking-wide rounded-lg bg-yellow-50 text-yellow-800" role="alert">
                    <svg class="flex-shrink-0 inline w-3 h-3 md:w-4 md:h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <?php if (!empty($cart)) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center space-x-3">
                                                <button data-modal-target="edit-cart-item-modal#<?= $item['id']; ?>" data-modal-toggle="edit-cart-item-modal#<?= $item['id']; ?>" type="button" class="text-blue-700 hover:text-blue-800 ease-in-out duration-300">
                ...
                <a href="<?= base_url('checkout'); ?>" class="btn-primary w-full mt-4 flex items-center justify-center space-x-2">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php else : ?>
                <div class="flex flex-col items-center justify-center h-full space-y-3">
                    ...
                    <h3 class="text-base md:text-lg font-medium">Keranjang Kosong</h3>
