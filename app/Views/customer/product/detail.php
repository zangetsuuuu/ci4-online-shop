            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="relative col-span-1 md:col-span-2 p-3 md:p-4">
                    <div class="space-y-1.5 mb-2.5 md:mb-3.5">
                        ...
                        <h2 class="text-myBlack text-lg md:text-xl font-semibold tracking-wide"><?= $product['name']; ?></h2>
                    ...
                    <p class="text-sm text-gray-500 tracking-wide leading-relaxed">
                        <?= $product['description']; ?>
                    </p>
                    <div class="mt-5">
                        <div class="flex items-center justify-between">
                            <h1 class="text-myBlack text-xl font-semibold tracking-wide">
