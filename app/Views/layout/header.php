            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-200 ease-in-out duration-200" aria-expanded="false" data-dropdown-toggle="dropdown-user" data-dropdown-placement="bottom-start">
        ...
        <aside id="sidebar" class="fixed top-0 left-0 z-[35] w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="/home" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'Home') ? 'bg-gray-100 text-blue-700' : 'text-myBlack' ?>">
                    ...
                    <li>
                        <a href="/cart" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'Cart') ? 'bg-gray-100 text-blue-700' : 'text-myBlack' ?>">
                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
                    <li>
                        <button class="flex items-center p-2 rounded-lg w-full hover:text-emerald-500 hover:bg-gray-100 group ease-in-out duration-200" aria-controls="contact-dropdown" data-collapse-toggle="contact-dropdown">
                            ...
                            <span class="flex-1 ms-3 text-left tracking-wide whitespace-nowrap">Kontak</span>
                        ...
                        <ul id="contact-dropdown" class="hidden py-2 space-y-2">
                            <li>
                                <a href="https://wa.me/6282110967112" class="flex items-center w-full p-2 text-myBlack tracking-wide rounded-lg pl-10 group hover:bg-gray-100 ease-in-out duration-200">Galva</a>
                            </li>
                            <li>
                                <a href="https://wa.me/6282110967112" class="flex items-center w-full p-2 text-myBlack tracking-wide rounded-lg pl-10 group hover:bg-gray-100 ease-in-out duration-200">Mamah Galva</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="/about-us" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'About Us') ? 'bg-gray-100 text-blue-700' : 'text-myBlack' ?>">
