    ...
    <div class="p-4 sm:ml-64">
        <div class="h-full bg-white rounded-lg shadow-sm p-4 mt-16 md:mt-14">
            <div class="flex items-center justify-between">
                ...
                <a href="<?= base_url('/profile'); ?>" class="flex items-center space-x-2 text-xs md:text-sm tracking-wide text-gray-500 hover:underline">
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-5">
                        ...
                        <div class="col-span-2 space-y-6">
                            ...
                            <div>
                                <label for="address" class="text-sm font-medium text-myBlack tracking-wide">No. HP <span class="text-red-500">*</span></label>
                                <textarea name="address" id="adress" class="block w-full h-20 md:h-30 p-2.5 mt-2 rounded-md bg-gray-50 border border-gray-300 placeholder-gray-400 text-myBlack focus:outline-none focus:ring-blue-700 focus:border-blue-700 focus:z-10 focus:shadow-md text-sm md:text-base resize-none" placeholder="Jl. Teratai No. 123"></textarea>
                            </div>
