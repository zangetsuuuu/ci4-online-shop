    ...
    <div class="p-4 sm:ml-64">
        <div class="h-full bg-white rounded-lg shadow-sm p-4 mt-16 md:mt-14">
            <div class="flex items-center justify-between">
                ...
                <button data-modal-target="order-filters-modal" data-modal-toggle="order-filters-modal" class="text-myBlack hover:text-gray-500 ease-in-out duration-300">
                            ...
                            <tr>
                                ...
                                <td class="px-7 py-4 whitespace-nowrap">
                                    <div class="flex items-center justify-center">
                                        <a href="<?= base_url("/order/$i"); ?>" class=" hover:text-myBlack ease-in-out duration-300">
...
<?= $this->include('layout/customers/orders/filters'); ?>
