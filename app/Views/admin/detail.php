        ...
        <div class="h-full p-4 mt-16 bg-white rounded-lg shadow-sm md:mt-14">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 md:space-x-3">
                    ...
                    <h1 class="text-lg font-semibold tracking-wide md:text-xl">Detail Admin</h1>
                </div>
                <a href="<?= base_url('admin/list'); ?>" class="flex items-center space-x-2 text-xs tracking-wide text-gray-500 md:text-sm hover:underline">
