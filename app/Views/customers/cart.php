        ...
        <div class="h-full bg-white rounded-lg shadow-sm p-4 mt-3 md:mt-4">
            <form action="">
                <div class="rounded-md overflow-x-auto">
                    <table class="min-w-[45rem] md:min-w-full text-sm text-gray-500 tracking-wide divide-y divide-gray-200 border border-gray-200 text-left">
                ...
                <button type="submit" name="checkout" class="btn-primary w-full mt-4 flex items-center justify-center space-x-2">
...
<?= $this->include('layout/customers/delete_cart'); ?>
