            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        <button data-drawer-target="sidebar" data-drawer-toggle="sidebar" aria-controls="sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 ease-in-out duration-200">
                    ...
                    <div class="flex items-center">
                        <div class="flex items-center ms-3">
                            <div>
                                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 ease-in-out duration-200" aria-expanded="false" data-dropdown-toggle="dropdown-user" data-dropdown-placement="bottom-start">
                            ...
                            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow" id="dropdown-user">
                                <div class="px-4 py-3" role="none">
                                    <p class="text-sm font-semibold text-gray-900 tracking-wide truncate" role="none">
                                        Rafif Athallah
                                    </p>
                                ...
                                <ul class="py-1" role="none">
                                    <li>
                                        <a href="#" class="block px-4 py-2 text-sm text-gray-900 tracking-wide hover:bg-gray-100 ease-in-out duration-200" role="menuitem">Edit profil</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block px-4 py-2 text-sm text-gray-900 tracking-wide hover:bg-gray-100 ease-in-out duration-200" role="menuitem">Ganti password</a>
                                    </li>
                                </ul>
                                <div class="py-1">
        ...
        <aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="/home" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'Home') ? 'bg-gray-100 text-blue-700' : 'text-gray-900' ?>">
                    ...
                    <li>
                        <a href="/cart" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'Cart') ? 'bg-gray-100 text-blue-700' : 'text-gray-900' ?>">
                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="/transaction" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'Transaction') ? 'bg-gray-100 text-blue-700' : 'text-gray-900' ?>">
                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
                    <li>
                        <a href="https://wa.me/6282110967112" target="_blank" class="flex items-center p-2 rounded-lg hover:text-emerald-500 hover:bg-gray-100 group ease-in-out duration-200">
                    ...
                    <li>
                        <a href="/about-us" class="flex items-center p-2 rounded-lg hover:text-blue-700 hover:bg-gray-100 group ease-in-out duration-200 <?= ($title == 'About Us') ? 'bg-gray-100 text-blue-700' : 'text-gray-900' ?>">
