    ...
    <div class="p-4 sm:ml-64">
        <div class="h-full bg-white rounded-lg p-4 mt-16 md:mt-14">
            ...
            <form action="">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php for ($j = 1; $j <= 3; $j++) : ?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        <input type="number" min="1" value="1" class="quantity w-16 h-8 rounded-md">
                                    </td>
                                    <td class="px-6 py-4">
                ...
                <button type="submit" name="getItemQty" class="btn-primary w-full mt-4 flex items-center justify-center space-x-2">
