    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                <h3 class="text-xl font-semibold text-myBlack tracking-wide">Cari Produk</h3>
            ...
            <form action="" method="GET">
                <div class="p-4 md:p-5">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="search" class="ps-10 p-2.5 block w-full mt-2 rounded-md bg-gray-50 border border-gray-300 placeholder-gray-400 text-myBlack focus:outline-none focus:ring-blue-700 focus:border-blue-700 focus:z-10 focus:shadow-md text-sm md:text-base" placeholder="Masukkan keyword..." required />
                    </div>
                </div>
                <!-- Modal footer -->
