    ...
    <div class="p-4 sm:ml-64">
        <div class="h-full bg-white rounded-lg p-4 mt-16 md:mt-14">
            <div class="flex items-center justify-between">
                ...
                <a href="<?= base_url("/admin/profile/1/edit"); ?>" class="flex items-center space-x-2 text-xs md:text-sm font-semibold tracking-wide text-emerald-500 hover:underline">
