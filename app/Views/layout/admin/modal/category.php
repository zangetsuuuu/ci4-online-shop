            ...
            <form action="">
                <div class="space-y-4 p-4 md:p-5">
                    <div class="flex items-center">
                        <input id="all" type="radio" value="all" name="category" checked class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                        <label for="all" class="ms-2 text-sm font-medium text-myBlack tracking-wide">Semua Kategori</label>
                    </div>
                    <div class="flex items-center">
                        <input id="staple" type="radio" value="staple" name="category" class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                        <label for="staple" class="ms-2 text-sm font-medium text-myBlack tracking-wide">Bahan Pokok</label>
                    </div>
                    <div class="flex items-center">
                        <input id="snack" type="radio" value="snack" name="category" class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                        <label for="snack" class="ms-2 text-sm font-medium text-myBlack tracking-wide">Snack</label>
                    </div>
                    <div class="flex items-center">
                        <input id="drinks" type="radio" value="drinks" name="category" class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                        <label for="drinks" class="ms-2 text-sm font-medium text-myBlack tracking-wide">Minuman</label>
                    </div>
                    <div class="flex items-center">
                        <input id="instant_food" type="radio" value="instant_food" name="category" class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                        <label for="instant_food" class="ms-2 text-sm font-medium text-myBlack tracking-wide">Makanan Instan</label>
                    </div>
                    <div class="flex items-center">
                        <input id="milk" type="radio" value="milk" name="category" class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                        <label for="milk" class="ms-2 text-sm font-medium text-myBlack tracking-wide">Susu</label>
                    </div>
                    <div class="flex items-center">
                        <input id="bread" type="radio" value="bread" name="category" class="w-4 h-4 text-emerald-500 bg-gray-100 border-gray-300 focus:ring-emerald-500">
                ...
                <div class="flex items-center justify-end space-x-3 p-4 md:p-5 border-t border-gray-200 rounded-b">
                    ...
                    <button type="submit" name="set_category" class="btn-admin">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
