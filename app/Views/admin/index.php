        ...
        <div class="h-full bg-white rounded-lg shadow-sm p-4 mt-16 md:mt-14">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 md:space-x-3">
                    ...
                    <h1 class="text-lg md:text-xl font-semibold tracking-wide">Admin</h1>
                </div>
                <button data-modal-target="admin-search-modal" data-modal-toggle="admin-search-modal" class="text-myBlack hover:text-gray-500 ease-in-out duration-300">
        ...
        <div class="h-full bg-white rounded-lg shadow-sm p-4 mt-3 md:mt-4">
            ...
            <?php if (session()->getFlashdata('Admin Search Info')) : ?>
                <div class="flex items-center justify-between p-3 md:p-4 text-sm text-gray-800 border border-gray-300 rounded-lg bg-gray-50 mb-4">
                    ...
                    <a href="<?= base_url('admin/list'); ?>" class="text-xs md:text-sm font-medium tracking-wide hover:underline">Reset</a>
                </div>
            <?php elseif (session()->getFlashdata('Admin Not Found')) : ?>
                <div class="flex items-center justify-between p-3 md:p-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50">
                    ...
                    <a href="<?= base_url('admin/list'); ?>" class="text-xs md:text-sm font-medium tracking-wide hover:underline">Kembali</a>
                </div>
            <?php endif; ?>
                                ...
                                <tr class="hover:bg-gray-50 ease-in-out duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center justify-center space-x-3">
                                            <a href="<?= base_url("admin/info/@$data[username]"); ?>" class="hover:text-myBlack ease-in-out duration-300">
                                            ...
                                            <button data-modal-target="delete-admin-modal#<?= $data['id']; ?>" data-modal-toggle="delete-admin-modal#<?= $data['id']; ?>" class="text-red-500 hover:text-red-600 ease-in-out duration-300">
